...
class Observe {
	...
	init() {
		var self = this 
		for ( let item in self._data ){
			// ES6的块级作用于 LET声明创建多个Dep实例
			// let dep = new Dep();
			(function(){
				var dep = new Dep()
				if ( self._data.hasOwnProperty(item) ){
					Object.defineProperty( self, item, {
						set: val=> {
							if (self._data[item] !== val){
								self._data[item] = val;
								dep.trigger();
							}
						},
...
var ins = new Observe({a: 1, b: 2})
new Watcher('a', ins, function(){
	console.log('I am watching aaaaa!')
})
new Watcher('b', ins, function(){
	console.log('I am watching bbbbb!')
})
ins.a = 2 // I am watching aaaaa!  I am watching bbbbb!
